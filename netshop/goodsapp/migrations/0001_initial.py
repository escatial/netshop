    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "colorurl",
                    models.ImageField(upload_to="color/", verbose_name="颜色保存路径"),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "oldprice",
                    models.DecimalField(
                        decimal_places=2, max_digits=5, verbose_name="商品原价"
                    ),
                ),
                (
                    "price",
                    models.DecimalField(
                        decimal_places=2, max_digits=5, verbose_name="商品现价"
                    ),
                ),
                (
                    "category",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("gdurl", models.ImageField(upload_to="", verbose_name="详情图片路径")),
                (
                    "detailname",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
